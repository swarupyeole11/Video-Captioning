...
if __name__ == "__main__" :
    ...
    for item in test:
        ...
        for caption in item['caption']:
            ...
            count = count+1
            a += rouge.get_scores(result[item['id']],caption)[0]['rouge-1']['r']

            # print(result[item['ScdUht-pM6s_53_63']])

        bleu.append(sum(score_per_video)/len(score_per_video))
    average = sum(bleu) / len(bleu)
    average_rouge = a / count
    print("Originally, average bleu score is " + str(average))
    print("Originally, average rouge score is " + str(average_rouge))
